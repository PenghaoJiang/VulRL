...
class BaseEnvAdapter(ABC):
    ...
    def get_terminal_reward(self) -> float | None:
        """
        Return a terminal reward computed by the adapter/runtime itself.

        This is primarily used by CTFMix where reward is based on final flag
        validation instead of trajectory similarity.
        """
        return None
