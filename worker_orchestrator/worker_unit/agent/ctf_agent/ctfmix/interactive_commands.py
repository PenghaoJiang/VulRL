    ...
    def communicate_with_handling(
        ...
        *,
        ...
        try:
            ...
            return observation, True
        # if command.strip() not in self.config.quit_commands_in_session and self.session_process.poll() is not None:
        #     self.logger.warning(
        #         "Interactive session %s exited unexpectedly with code %s",
        #         self.name,
        #         self.session_process.returncode,
        #     )
        #     return observation, True
