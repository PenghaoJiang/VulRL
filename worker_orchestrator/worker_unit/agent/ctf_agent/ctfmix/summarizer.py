...
from .models import APIStats, BaseModel, ContextWindowExceededError, ModelArguments
from .runtime_utils import copy_anything_to_container
...
class SummarizerConfig(FrozenSerializable):
    ...
    def __post_init__(self):
        ...
        if isinstance(self.model, dict):
            object.__setattr__(self, "model", ModelArguments.from_dict(self.model))  # type: ignore[arg-type]
