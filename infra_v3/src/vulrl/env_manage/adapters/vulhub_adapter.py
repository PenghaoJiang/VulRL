...
Converts Vulhub Docker environments to standard interface
"""
...
class VulhubAdapter(BaseEnvAdapter):
    ...
    Responsibilities:
    1. Start/stop Vulhub Docker Compose environments
    2. Standardize Vulhub inputs/outputs
    3. Execute tools in attacker container
    """
    ...
    def reset_backend(self) -> str:
        """
        Reset backend Vulhub environment
...
"""
    ...
    def step_backend(self, action: StandardAction) -> Tuple[str, float, bool, Dict]:
        ...
        # Don't determine done here (unified environment handles it)
        done = False
    ...
    def _start_attacker(self):
        ...
        try:
            ...
            print(f"[VulhubAdapter] Started attacker: attacker_{self.project_name}")
        except Exception as e:
